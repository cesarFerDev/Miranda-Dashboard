...
import { getRoom, loadRooms } from "../../features/rooms/roomsThunks";
...
export const BookingDetails = () => {
    ...
    const {id} = useParams();
    const singleBookingData = bookingsData.find(booking => booking.id === id);
    //const singleBookingData.room = roomsData.find(room => room.id === singleBookingData?.room.id);
    ...
    useEffect(() => {
        ...
        // if (roomsStatus === "idle") {
        //     dispatchApp(loadRooms());
        // } else if (singleBookingData && !(singleBookingData.room)) {
        //     dispatchApp(getRoom(singleBookingData.room.id!))
        //}
    });
