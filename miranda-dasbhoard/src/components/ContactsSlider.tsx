...
// export const createContactCard = (contact: Contact) => {
//     return (
//         <ContactSliderCard>
//             <ContactCardTop>
...
//                 <ArchiveButton onClick={() => dispatch(archiveContacts(contact.contact_id))} className="archive-slider-btn">Archive</ArchiveButton>
//             </ContactCardBottom>
//         </ContactSliderCard>
//     );
// };
    ...
    return (<>
        <ContactsSliderSection>
            ...
            <ContactsSliderSwiper spaceBetween={20} modules={[Navigation]} navigation={true} slidesPerView={3}>
                {orderContacts(contactsData, "Not Archived").map(contact => {
                    return (
                        <ContactSliderCard>
                            <ContactCardTop>
                                <h4>{contact.content_title}</h4>
