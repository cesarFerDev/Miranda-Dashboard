...
export const Rooms = () => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(RoomsFiltersContainer, null,
            React.createElement(CreateLink, { to: "/rooms/create" }, "+ New Room"),
            React.createElement(EditButton, null, "Order By")),
        React.createElement(Table, { section: sectionName, cols: roomsCols, data: roomsData })));
};
